...
### Standard Task Workflow (Beads & Jujutsu)

1. **Select Task:** Run `bd ready` to find the next prioritized task.
2. **Mark In Progress:** Run `bd update <id> --status in_progress` to claim the task.
3. **Write Failing Tests (Red Phase):**
   - Create a new test file for the feature or bug fix.
   - Write one or more unit tests that clearly define the expected behavior and acceptance criteria for the task.
   - **CRITICAL:** Run the tests (`npx vitest run`) and confirm that they fail as expected. This is the "Red" phase of TDD. Do not proceed until you have failing tests.
...
6. **Verify Coverage:** Run coverage reports using Vitest (e.g., `npx vitest run --coverage`).
...
8. **Task Closure & Commit:**
   - **Close Task:** Run `bd close <id> --reason "Implemented <feature>..."`
   - **Commit:** Run `jj commit -m "<type>(<scope>): <description>"`
...
7. Changes committed with proper message including Beads Task ID
8. Task closed in Beads (`bd close`)
