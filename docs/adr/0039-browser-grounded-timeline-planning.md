...
2. Review checkpoint screenshots.
3. Patch only broken checkpoint plans.
4. Recompile per-commit plan DB.
5. Run full capture with no agent.
6. Render timeline video.
