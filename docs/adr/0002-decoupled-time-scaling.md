...
2.  **Pause Fix**: When `scaledDt` is 0, the engine stops updating entirely, ensuring threat and interactions freeze correctly.
3.  **Simplicity**: Simplifies the engine logic and makes "Speed Scaling" a global multiplier for all game events.
