...
2.  Screen management and navigation flow.
3.  Mission lifecycle (launch, resume, abort, reconcile).
4.  Tactical input processing (panning, zooming, unit selection).
5.  Global UI synchronization (HUD, speed controls, responsive drawers).
