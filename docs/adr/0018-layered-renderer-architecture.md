...
1. **Maintainability:** Adding a new visual effect (e.g., a status icon) requires modifying the core render loop.
1. **Complexity:** Asset loading, coordinate transformation, and drawing logic are intertwined.
