...
This directory contains persona-driven use cases for the Voidlock game. These stories are used by automated agents to conduct visual and logical audits of the user experience.
...
- [US_006: Objective Extraction](./US_006_Loot_Objectives.md) - Collecting artifacts/loot and reaching extraction.
- [US_007: V.I.P. Protection](./US_007_Escort.md) - Using the Escort command.

## Result & Progression

- [US_008: After Action Report](./US_008_Debrief.md) - Reviewing mission results and XP gain.
- [US_010: Campaign Conclusion](./US_010_Campaign_End.md) - Final Victory and Defeat summaries.
