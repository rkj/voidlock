...
| :-------------------- | :--------------- | :-------------------------------------------------------------------------- |
| **Recover Intel** | Upload Data Disk | The **Data Disk** is uploaded after a 3s interaction. No extraction needed. |
| **Search & Recover** | Secure Artifact | The **Artifact** must be carried to Extraction. If the carrier dies, it drops and another soldier can recover it. |
...
- **Objective Complete:** All Primary Objectives are met.
  ...
  - _Recover Intel_: Data Disks uploaded.
