...
describe("regression_voidlock_4eeb_loot_spawning", () => {
  ...
  beforeEach(async () => {
    mockCampaignState = {
      ...
      roster: [
          { id: "s1", name: "S1", archetypeId: "scout", status: "Healthy", level: 1, hp: 100, maxHp: 100, xp: 0, kills: 0, missions: 0, recoveryTime: 0, soldierAim: 80, equipment: { rightHand: "pulse_rifle", leftHand: undefined, body: "basic_armor", feet: undefined } }
      ],
      scrap: 100,
      intel: 0,
      currentSector: 1,
  ...
  it("should pass bonusLootCount to GameClient.init during campaign mission launch", async () => {
    ...
    // 4. Verify GameClient.init was called with bonusLootCount: 5
