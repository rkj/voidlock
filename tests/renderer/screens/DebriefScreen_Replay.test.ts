...
describe("DebriefScreen Replay Button", () => {
  ...
  it("should show Replay button only for custom missions", () => {
    ...
    const replayBtn = buttons.find((b) => b.textContent === "Analyze Tactical Feed");
    ...
    const replayBtn2 = buttons2.find((b) => b.textContent === "Analyze Tactical Feed");
  ...
  it("should call onReplay when button is clicked", () => {
    ...
    const replayBtn = buttons.find(
      (b) => b.textContent === "Analyze Tactical Feed",
