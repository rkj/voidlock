...
import { GameState, UnitStyle, UnitState, MissionType, EngineMode } from "../../src/shared/types";
...
describe("Renderer - unitStyle", () => {
  ...
  const mockState: GameState = {
    ...
    units: [{
      ...
      archetypeId: "assault",
      stats: { damage: 10, fireRate: 1000, accuracy: 80, soldierAim: 80, attackRange: 5, speed: 20, equipmentAccuracyBonus: 0 },
