...
import { MapDefinition, CellType, UnitState, Objective, SquadConfig } from '../../../shared/types';
...
describe('Hidden Objectives', () => {
  ...
  beforeEach(() => {
    ...
    const objectives: Objective[] = [
        { id: 'obj1', kind: 'Recover', state: 'Pending', targetCell: { x: 9, y: 9 } }
    ];
    map = {
      width: 10, height: 10,
      cells,
  ...
  it('should be hidden initially and revealed when discovered', () => {
    ...
    engine.addUnit({
      id: 'u1', pos: { x: 0.5, y: 0.5 }, hp: 100, maxHp: 100, state: UnitState.Idle, damage: 10, fireRate: 100, attackRange: 1, sightRange: 5, speed: 2, commandQueue: []
    });
