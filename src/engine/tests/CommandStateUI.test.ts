...
import { MapDefinition, CellType, UnitState, CommandType, MissionType } from '../../shared/types';
...
describe('Unit Command State UI Tracking', () => {
    ...
    beforeEach(() => {
        engine = new CoreEngine(map, 123, [{ archetypeId: 'assault', count: 1 }], false, false);
    });
    ...
    it('should set activeCommand for autonomous exploration', () => {
        ...
        engine = new CoreEngine(longMap, 123, [{ archetypeId: 'assault', count: 1 }], true, false);
