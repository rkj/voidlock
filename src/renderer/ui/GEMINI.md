...
- **HUD Updates**: Synchronizes the DOM elements with the current `GameState`. Now displays full unit stats including Accuracy, Fire Rate, and Effective Range (EffR).
