...
- `CampaignScreen.ts`: Visualizes the Sector Map (DAG) for the campaign mode. Allows navigation between nodes and mission selection. Includes a "New Campaign" wizard with difficulty selection and tactical pause options if no active campaign exists.
