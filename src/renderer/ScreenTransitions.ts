...
export const VALID_TRANSITIONS: Record<ScreenId, ScreenId[]> = {
  ...
  campaign: ["main-menu", "barracks", "equipment", "mission", "mission-setup", "campaign-summary", "statistics"],
  "mission-setup": ["main-menu", "equipment", "mission", "campaign", "barracks", "statistics"],
  equipment: ["campaign", "mission-setup", "mission", "main-menu", "barracks", "statistics"],
