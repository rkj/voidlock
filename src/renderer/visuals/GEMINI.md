...
- `MapEntityLayer.ts`: Renders static map entities like spawn points, extraction zones, loot crates, and objectives. Respects `unitStyle`, using geometric shapes instead of sprites when set to `TacticalIcons`.
